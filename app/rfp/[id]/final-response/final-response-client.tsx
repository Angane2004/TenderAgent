...
export default function FinalResponseClient({ id }: FinalResponseClientProps) {
    ...
    const generatePDF = () => {
        ...
        setTimeout(() => {
            ...
            doc.text("Commercial Offer: INR 26,25,000", 20, 100)
            doc.text("Delivery Timeline: 90 Days", 20, 110)
                                ...
                                {!isSubmitted ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center h-full py-12 space-y-4">
                                        ...
                                        <p className="text-center text-gray-600">
                                            ...
                                            Reference ID: SUB-{Math.floor(Math.random() * 10000)}
                                        </p>
                                        <Button
